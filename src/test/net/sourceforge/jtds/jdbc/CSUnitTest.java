    ...
    */
    ...
    public void testxx0052() throws Exception {
        ...
        try {
            ...
            "   myvarbinary)                 " +
            " values                         " +
            "  (\'This is a test with german umlauts ÄäÖöÜüß€', " +
            ...
            if (!rs.next()) {
                ...
                expect = "This is a test with german umlauts ÄäÖöÜüß€";
    ...
    public void testxx0053() throws Exception {
        ...
        try {
            ...
            if (!rs.next()) {
               ...
               test = rs.getString(2);
               if (test.length() != 2000 || ! "ÄäÖöÜüß€".equals(test.trim())) {
                   fail("Testing nchar: failed, got \'"+test.trim()+"\' instead of \'ÄäÖöÜüß€\'");
               }

               test = rs.getString(3);
               if (test.length() != 6 || ! "ÄäÖöÜüß€".equals(test)) {
                   fail("Testing nvarchar: failed, got \'"+test+"\' instead of \'ÄäÖöÜüß€\'");
               }

               test = rs.getString(4);
               if (test.length() != 6 || ! "ÄäÖöÜüß€".equals(test)) {
                   fail("Testing ntext: failed, got \'"+test+"\' instead of \'ÄäÖöÜüß€\'");
               }
            }
        } catch (java.sql.SQLException e) {
            passed = false;
