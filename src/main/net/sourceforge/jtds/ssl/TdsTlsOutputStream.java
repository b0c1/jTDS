...
class TdsTlsOutputStream extends FilterOutputStream {
	//set data offset base on the runtime version
	private static int OFFSET = System.getProperty("java.version").startsWith("1.8.") ? Ssl.TLS_DATA_OFFSET_1_8 :
		Ssl.TLS_DATA_OFFSET_1_7;
    /**
